...
A _type predicate_ is a special kind of function return type. It tells the Typescript compiler what type a piece of data is.
...
The Typescript compiler relies heavily on _type predicates_ to determine or not your code is safe to compile.
