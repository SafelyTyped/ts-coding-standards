...
A _value object_ is a [value][Value] that's defined by a class.

Object-programming programming communities (in particular) often use _value object_ and _value_ to mean the same thing.
