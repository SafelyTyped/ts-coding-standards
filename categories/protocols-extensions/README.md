# Protocols and Exceptions Coding Standards
...
We've decided to keep our safe types as small as possible. Our types are going to have the minimum functionality required to create them and access the data they hold. We're going to put all other functionality into Swift-style [protocols][Protocol] and [extensions][Extension], instead of into ever-growing class definitions.

## What Is In Scope?

Currently in-scope are:

* any interfaces that are intended to be used as [protocols][Protocol]
* any classes that are intended to be used as [extensions][Extension]
