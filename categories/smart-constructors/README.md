# Smart Constructor Coding Standards
...
[Smart constructors][Smart Constructor] create safe types.

* they enforce the contract about what is and isn't valid data for a given type
* they create that given type
* (optionally) they apply [functional options][User-Supplied Functional Options] to the newly-built type

They are one of the main parts of our public API.

## What Is In Scope?

Currently in-scope are:

- specific points about the design of [smart constructors][Smart Constructor]
- specific points about the implementation of [smart constructors][Smart Constructor]
...
* any [general points about types][types]
* anything specific about [data guards][data-guards], [data guarantees][data-guarantees], [type guards][type-guards] or [type guarantees][type-guarantees]
* [our naming conventions][naming-conventions]
