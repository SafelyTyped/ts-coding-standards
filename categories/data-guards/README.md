...
_Data guards_ are like [type guards][Type Guard], only they validate the contents of the data.

They're used in [data guarantees][Data Guarantee] to create the [smart constructors][Smart Constructor] for our safe types.

## What Is In Scope?

Currently in-scope is:

* anything that's specific to a data guard
