# 3.4.6 - One Exported Type Per File
...
Put exported types in their own files.

```typescript
// src/v1/OnError/OnErrorOptions.ts
export interface OnErrorOptions { ... };

// src/v1/ContentType/MakeContentTypeOptions.ts
export type MakeContentTypeOptions = OnErrorOptions;

// src/v1/MediaType/MakeMediaTypeOptions.ts
export type MakeMediaTypeOptions = OnErrorOptions;
```
...
We are putting exported types into their own files to make it easier to navigate around a source tree.
...
We are putting exported types into their own files to make code reviews easier.
