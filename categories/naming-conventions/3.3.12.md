# 3.3.12 - Do Not Use Blacklist Or Whitelist
...
Do not name anything `blacklist` or `whitelist`.

Do not use any variation of these terms either.
...
Additional terms are welcome. Please raise an issue to suggest them.

## Discussion

This is specific guidance for meeting our coding standard [1.3.1][1.3.1].
