# Data Guarantee Coding Standards
...
A data guarantee_ is a function that throws an `Error` if the input doesn't contain data that passes validation. We call them to improve the robustness of our code.
...
[Data guarantees][Data Guarantee] are an important building block for our [smart constructors][Smart Constructor].

## What Is In Scope?

Currently in-scope is:

* anything that's specific to a data guarantee

## What Is Out Of Scope?

* any specific points about [type guarantees][type-guarantees]
